      ...
      <div className="mx-auto max-w-content px-5 py-14 sm:px-8 sm:py-16 lg:px-0 lg:py-20">
        <div className="grid gap-12 md:grid-cols-[1.5fr_1fr_1fr_1fr] lg:gap-16">
          <div>
            ...
            <p className="mt-5 max-w-[270px] font-causten text-base leading-7 text-white/65">{t("footer.description")}</p>
          ...
          {columns.map((column) => (
            <div key={column.title}>
              <h2 className="font-core text-lg font-semibold">{t(`footer.${column.title.toLowerCase()}`)}</h2>
